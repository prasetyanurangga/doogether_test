...
$config = [
    ...
    'components' => [
        'request' => [
            ...
            'cookieValidationKey' => 'jdsfiGVYTu65duwyTlAvjPMNRfPS5S1B',
        ],
        'api' => [
            'class' => 'app\component\Api',
        ],

        'apiFactory' => [
            'class' => 'app\factory\ApiResponseDataFactory',
        ],
        'response' => [
            ...
            'on beforeSend' => function ($event) {
                ...
                if ($response->data !== null && !$response->isSuccessful) {
                    $status =  (!isset($response->data['status']) || $response->data['status'] == 0) ? 500 : $response->data['status'];
                    $response->data = [
                        'status' => $status,
